...
impl Mesh {
    pub fn create(gl: &WebGlRenderingContext, vertices: &[f32], indices: &[u16])
                  -> Result<Self, JsValue>
    {
        ...
        gl.vertex_attrib_pointer_with_i32(1, 3, WebGlRenderingContext::FLOAT, false, stride, 3 * float_size);
        gl.enable_vertex_attrib_array(1);

        gl.vertex_attrib_pointer_with_i32(2, 3, WebGlRenderingContext::FLOAT, false, stride, 5 * float_size);
